                        ...
                        <tr wire:key="<?php echo e($empresa->id_empresa); ?>" class="hover:bg-gray-50 transition-colors duration-150">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-center">
                                <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full 
                                    <?php if($empresa->estado_inicial == 'Activo'): ?> bg-green-100 text-green-800 
                                    <?php elseif($empresa->estado_inicial == 'Inactivo'): ?> bg-red-100 text-red-800 
                                    <?php elseif($empresa->estado_inicial == 'En Proceso'): ?> bg-yellow-100 text-yellow-800 
                                    <?php elseif($empresa->estado_inicial == 'Suspendido'): ?> bg-gray-100 text-gray-800 
                                    <?php endif; ?>">
