                ...
                <div class="bg-white p-6 rounded-2xl shadow-lg border border-gray-100/50 backdrop-blur-sm">
                    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
                        <div class="space-y-3">
                            ...
                            <div class="flex items-center gap-4">
                                <span class="inline-flex items-center px-3 py-1.5 rounded-full bg-gradient-to-r from-blue-100 to-indigo-100 text-blue-700 font-medium text-sm shadow-sm border border-blue-200/50">
                                    ...
                                    <?php echo e($empresas->total()); ?> <?php echo e($empresas->total() == 1 ? 'Empresa' : 'Empresas'); ?>

                                </span>
                                <!--[if BLOCK]><![endif]--><?php if($busqueda || $filtroSector || $filtroEstado): ?>
                        ...
                        <div class="flex items-center gap-3 flex-wrap">
                            <!-- Botón Nueva Empresa -->
                            <a href="<?php echo e(route('crear-empresa')); ?>" wire:navigate
                            ...
                            <!-- Botón Papelera -->
                            <a href="<?php echo e(route('papelera-empresas')); ?>" wire:navigate
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <th scope="col" wire:click="ordenar('id_empresa')"
                                    ...
                                    <div class="flex items-center">
                                        <span>ID</span>
                                        <!--[if BLOCK]><![endif]--><?php if($ordenarPor === 'id_empresa'): ?>
                                ...
                                <th scope="col" wire:click="ordenar('nombre_comercial')"
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php if($ordenarPor === 'nombre_comercial'): ?>
                                        <span class="ml-1 transform transition-transform duration-200 <?php echo e($direccionOrden === 'asc' ? 'rotate-0' : 'rotate-180'); ?>">
                                            <svg class="w-4 h-4 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 15l7-7 7 7" />
                                            </svg>
                                ...
                                <th scope="col" wire:click="ordenar('rfc')"
                                    ...
                                    <div class="flex items-center">
                                        <span>RFC</span>
                                        <!--[if BLOCK]><![endif]--><?php if($ordenarPor === 'rfc'): ?>
                                        <span class="ml-1 transform transition-transform duration-200 <?php echo e($direccionOrden === 'asc' ? 'rotate-0' : 'rotate-180'); ?>">
                                            <svg class="w-4 h-4 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 15l7-7 7 7" />
                                            </svg>
                                ...
                                <th scope="col" wire:click="ordenar('sector')"
                                    ...
                                    <div class="flex items-center">
                                        <span>Sector</span>
                                        <!--[if BLOCK]><![endif]--><?php if($ordenarPor === 'sector'): ?>
                                        <span class="ml-1 transform transition-transform duration-200 <?php echo e($direccionOrden === 'asc' ? 'rotate-0' : 'rotate-180'); ?>">
                                            <svg class="w-4 h-4 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 15l7-7 7 7" />
                                            </svg>
                                ...
                                <th scope="col" wire:click="ordenar('pais')"
                                    ...
                                    <div class="flex items-center">
                                        <span>País</span>
                                        <!--[if BLOCK]><![endif]--><?php if($ordenarPor === 'pais'): ?>
                                        <span class="ml-1 transform transition-transform duration-200 <?php echo e($direccionOrden === 'asc' ? 'rotate-0' : 'rotate-180'); ?>">
                                            <svg class="w-4 h-4 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 15l7-7 7 7" />
                                            </svg>
                                ...
                                <th scope="col" wire:click="ordenar('fecha_registro')"
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php if($ordenarPor === 'fecha_registro'): ?>
                                        <span class="ml-1 transform transition-transform duration-200 <?php echo e($direccionOrden === 'asc' ? 'rotate-0' : 'rotate-180'); ?>">
                                            <svg class="w-4 h-4 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 15l7-7 7 7" />
                                            </svg>
                                ...
                                <th scope="col" wire:click="ordenar('estado_inicial')"
                                    ...
                                    <div class="flex items-center justify-center">
                                        <span>Estado</span>
                                        <!--[if BLOCK]><![endif]--><?php if($ordenarPor === 'estado_inicial'): ?>
                                        <span class="ml-1 transform transition-transform duration-200 <?php echo e($direccionOrden === 'asc' ? 'rotate-0' : 'rotate-180'); ?>">
                                            <svg class="w-4 h-4 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 15l7-7 7 7" />
                                            </svg>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr wire:key="<?php echo e($empresa->id_empresa); ?>"
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-center">
                                    <span class="px-3 py-1.5 inline-flex text-xs leading-5 font-semibold rounded-full shadow-sm transition-all duration-200
                                        <?php if($empresa->estado_inicial == 'Activo'): ?> bg-gradient-to-r from-green-100 to-emerald-100 text-green-800 border border-green-200
                                        <?php elseif($empresa->estado_inicial == 'Inactivo'): ?> bg-gradient-to-r from-red-100 to-rose-100 text-red-800 border border-red-200
                                        <?php elseif($empresa->estado_inicial == 'En Proceso'): ?> bg-gradient-to-r from-yellow-100 to-amber-100 text-yellow-800 border border-yellow-200
                                        <?php elseif($empresa->estado_inicial == 'Suspendido'): ?> bg-gradient-to-r from-gray-100 to-slate-100 text-gray-800 border border-gray-200
                                        <?php endif; ?>">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex justify-end space-x-2">
                                        <!-- Botón Ver -->
                                        <a
                                            href="<?php echo e(route('ver-empresa', $empresa)); ?>"
                                            wire:navigate
                                        ...
                                        <!-- Botón Editar -->
                                        <a
                                            href="<?php echo e(route('editar-empresa', $empresa)); ?>"
                                            wire:navigate
