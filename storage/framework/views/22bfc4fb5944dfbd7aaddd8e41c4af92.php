            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between">
                ...
                <div class="mt-4 md:mt-0">
                    <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-indigo-100 text-indigo-800">
                        ...
                        <?php echo e($evaluacionesPendientes->count()); ?> pendientes
                    </span>
                </div>
            </div>
        </div>

        <!--[if BLOCK]><![endif]--><?php if($evaluacionesPendientes->count() > 0): ?>
            
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $evaluacionesPendientes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $evaluacion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                    ...
                    <div class="bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 p-6 border-l-4 <?php echo e($estadoColor); ?>">
                        
                        <div class="flex items-start justify-between mb-3">
                            <h3 class="text-lg font-semibold text-gray-900 leading-tight">
                                <?php echo e($evaluacion->tipo_evaluacion); ?>

                            </h3>
                            <span class="px-3 py-1 <?php echo e($badgeColor); ?> text-xs font-semibold rounded-full whitespace-nowrap ml-2">
                        ...
                        <p class="text-gray-600 text-sm mb-4 line-clamp-2">
                            <?php echo e($evaluacion->descripcion_evaluacion); ?>
                        ...
                        <div class="flex items-center justify-between text-sm text-gray-500 mb-4">
                            <div class="flex items-center space-x-4">
                                <div class="flex items-center">
                                    ...
                                    <span class="ml-1 <?php echo e($diasRestantes <= 3 ? 'text-red-600 font-semibold' : ''); ?>">
                                        <?php echo e($evaluacion->fecha_cierre->format('d M Y')); ?>
                                ...
                                <!--[if BLOCK]><![endif]--><?php if($diasRestantes > 0): ?>
                                    <div class="flex items-center">
                                        ...
                                        <span><?php echo e($diasRestantes); ?> días restantes</span>
                                    </div>
                        ...
                        <a href="<?php echo e(route('realizar-evaluacion', ['uuid' => $evaluacion->uuid_encuesta])); ?>" 
...
</div><?php /**PATH D:\laragon\www\encuesta-pro360\resources\views/livewire/encuesta/evaluacion/mis-evaluaciones.blade.php ENDPATH**/ ?>