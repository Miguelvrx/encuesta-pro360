<div>
            ...
            <div class="mt-6">
                ...
                <div class="mt-3">
                    <button wire:click="toggleMenu('usuarios')" class="w-full flex items-center justify-between px-3 py-2.5 rounded-lg group transition-all duration-200 ease-in-out 
                        <?php echo e($this->isActiveRouteGroup(['crear-empresa', 'mostrar-empresa']) ? 'bg-blue-50 text-blue-600 shadow-sm' : 'text-gray-600 hover:text-blue-600 hover:bg-blue-50 hover:shadow-md'); ?>">
                        <div class="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-3 transition-colors duration-200 
                                <?php echo e($this->isActiveRouteGroup(['crear-empresa', 'mostrar-empresa']) ? 'text-blue-500' : 'text-gray-400 group-hover:text-blue-500'); ?>" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div class="overflow-hidden transition-all duration-300 ease-in-out 
                        ...
                        <a href="<?php echo e(route('mostrar-empresa')); ?>"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-3 transition-colors duration-200 
                                <?php echo e($this->isActiveRoute('mostrar-empresa') ? 'text-blue-500' : 'text-gray-400 group-hover:text-blue-500'); ?>" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div class="mt-3">
                        ...
                        <?php echo e($this->isActiveRouteGroup(['crear-departamento', 'mostrar-departamento']) ? 'bg-blue-50 text-blue-600 shadow-sm' : 'text-gray-600 hover:text-blue-600 hover:bg-blue-50 hover:shadow-md'); ?>">
                            <div class="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-3 transition-colors duration-200 
    ...
    <?php echo e($this->isActiveRoute('catalogo-competencia') ? 'bg-blue-50 text-blue-600 border-r-4 border-blue-600 shadow-sm' : 'text-gray-600 hover:text-blue-600 hover:bg-blue-50 hover:shadow-md'); ?>">
        ...
        <?php echo e($this->isActiveRoute('catalogo-competencia' ) ? 'text-blue-500' : 'text-gray-400 group-hover:text-blue-500'); ?>" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <?php echo e($this->isActiveRouteGroup(['gestionar-pregunta']) ? 'bg-blue-50 text-blue-600 shadow-sm' : 'text-gray-600 hover:text-blue-600 hover:bg-blue-50 hover:shadow-md'); ?>">
                                    <div class="flex items-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-3 transition-colors duration-200 
                                <?php echo e($this->isActiveRouteGroup(['gestionar-pregunta']) ? 'text-blue-500' : 'text-gray-400 group-hover:text-blue-500'); ?>" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    ...
                                    <svg class="w-4 h-4 transition-all duration-300 ease-in-out 
                            <?php echo e($this->isActiveRouteGroup(['gestionar-pregunta']) ? 'text-blue-400' : 'text-gray-400'); ?> 
                            <?php echo e($this->isMenuOpen('preguntas') ? 'rotate-180' : 'rotate-0'); ?>" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                                    </svg>
                                </button>
                                <div class="overflow-hidden transition-all duration-300 ease-in-out 
                        <?php echo e($this->isMenuOpen('preguntas') ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0'); ?> mt-1 ml-4 space-y-1">
                                    <a href="<?php echo e(route('gestionar-pregunta')); ?>"
                                        wire:click="closeMenus"
                                        class="flex items-center px-3 py-2.5 rounded-lg group transition-all duration-200 ease-in-out 
                            <?php echo e($this->isActiveRoute('gestionar-pregunta') ? 'bg-blue-50 text-blue-600 border-r-4 border-blue-600 shadow-sm' : 'text-gray-600 hover:text-blue-600 hover:bg-blue-50 hover:shadow-md'); ?>">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-3 transition-colors duration-200 
                                <?php echo e($this->isActiveRoute('gestionar-pregunta') ? 'text-blue-500' : 'text-gray-400 group-hover:text-blue-500'); ?>" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <?php echo e($this->isActiveRouteGroup(['crear-evaluacion', 'mostrar-evaluaciones']) ? 'bg-blue-50 text-blue-600 shadow-sm' : 'text-gray-600 hover:text-blue-600 hover:bg-blue-50 hover:shadow-md'); ?>">
                                        <div class="flex items-center">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-3 transition-colors duration-200 
                                <?php echo e($this->isActiveRouteGroup(['crear-evaluacion', 'mostrar-evaluaciones']) ? 'text-blue-500' : 'text-gray-400 group-hover:text-blue-500'); ?>" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        ...
                                        <svg class="w-4 h-4 transition-all duration-300 ease-in-out 
                            <?php echo e($this->isActiveRouteGroup(['crear-evaluacion', 'mostrar-evaluaciones']) ? 'text-blue-400' : 'text-gray-400'); ?> 
                            <?php echo e($this->isMenuOpen('evaluaciones') ? 'rotate-180' : 'rotate-0'); ?>" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                                        </svg>
                                    </button>
                                    <div class="overflow-hidden transition-all duration-300 ease-in-out 
                        <?php echo e($this->isMenuOpen('evaluaciones') ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0'); ?> mt-1 ml-4 space-y-1">
                                        <a href="<?php echo e(route('crear-evaluacion')); ?>"
                                            wire:click="closeMenus"
                                            class="flex items-center px-3 py-2.5 rounded-lg group transition-all duration-200 ease-in-out 
                            <?php echo e($this->isActiveRoute('crear-evaluacion') ? 'bg-blue-50 text-blue-600 border-r-4 border-blue-600 shadow-sm' : 'text-gray-600 hover:text-blue-600 hover:bg-blue-50 hover:shadow-md'); ?>">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-3 transition-colors duration-200 
                                <?php echo e($this->isActiveRoute('crear-evaluacion') ? 'text-blue-500' : 'text-gray-400 group-hover:text-blue-500'); ?>" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        ...
                                        <a href="<?php echo e(route('mostrar-evaluaciones')); ?>"
                                            wire:click="closeMenus"
                                            class="flex items-center px-3 py-2.5 rounded-lg group transition-all duration-200 ease-in-out 
                            <?php echo e($this->isActiveRoute('mostrar-evaluaciones') ? 'bg-blue-50 text-blue-600 border-r-4 border-blue-600 shadow-sm' : 'text-gray-600 hover:text-blue-600 hover:bg-blue-50 hover:shadow-md'); ?>">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-3 transition-colors duration-200 
                                <?php echo e($this->isActiveRoute('mostrar-evaluaciones') ? 'text-blue-500' : 'text-gray-400 group-hover:text-blue-500'); ?>" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <?php echo e($this->isActiveRouteGroup(['mis-evaluaciones']) ? 'bg-blue-50 text-blue-600 shadow-sm' : 'text-gray-600 hover:text-blue-600 hover:bg-blue-50 hover:shadow-md'); ?>">
                                            <div class="flex items-center">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-3 transition-colors duration-200 
                                <?php echo e($this->isActiveRouteGroup(['mis-evaluaciones']) ? 'text-blue-500' : 'text-gray-400 group-hover:text-blue-500'); ?>" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            ...
                                            <svg class="w-4 h-4 transition-all duration-300 ease-in-out 
                            <?php echo e($this->isActiveRouteGroup(['mis-evaluaciones']) ? 'text-blue-400' : 'text-gray-400'); ?> 
                            <?php echo e($this->isMenuOpen('realizarevaluaciones') ? 'rotate-180' : 'rotate-0'); ?>" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                                            </svg>
                                        </button>
                                        <div class="overflow-hidden transition-all duration-300 ease-in-out 
                        <?php echo e($this->isMenuOpen('realizarevaluaciones') ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0'); ?> mt-1 ml-4 space-y-1">
                                            <a href="<?php echo e(route('mis-evaluaciones')); ?>"
                                                wire:click="closeMenus"
                                                class="flex items-center px-3 py-2.5 rounded-lg group transition-all duration-200 ease-in-out 
                            <?php echo e($this->isActiveRoute('mis-evaluaciones') ? 'bg-blue-50 text-blue-600 border-r-4 border-blue-600 shadow-sm' : 'text-gray-600 hover:text-blue-600 hover:bg-blue-50 hover:shadow-md'); ?>">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-3 transition-colors duration-200 
                                <?php echo e($this->isActiveRoute('mis-evaluaciones') ? 'text-blue-500' : 'text-gray-400 group-hover:text-blue-500'); ?>" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <?php echo e($this->isActiveRouteGroup(['reporte-evaluacion']) ? 'bg-blue-50 text-blue-600 shadow-sm' : 'text-gray-600 hover:text-blue-600 hover:bg-blue-50 hover:shadow-md'); ?>">
                                                <div class="flex items-center">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-3 transition-colors duration-200 
                                <?php echo e($this->isActiveRouteGroup(['reporte-evaluacion']) ? 'text-blue-500' : 'text-gray-400 group-hover:text-blue-500'); ?>" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                ...
                                                <svg class="w-4 h-4 transition-all duration-300 ease-in-out 
                            <?php echo e($this->isActiveRouteGroup(['reporte-evaluacion']) ? 'text-blue-400' : 'text-gray-400'); ?> 
                            <?php echo e($this->isMenuOpen('reporteevaluaciones') ? 'rotate-180' : 'rotate-0'); ?>" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                                                </svg>
                                            </button>
                                            <div class="overflow-hidden transition-all duration-300 ease-in-out 
                        <?php echo e($this->isMenuOpen('reporteevaluaciones') ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0'); ?> mt-1 ml-4 space-y-1">
                                                <a href="<?php echo e(route('reporte-evaluacion')); ?>"
                                                    wire:click="closeMenus"
                                                    class="flex items-center px-3 py-2.5 rounded-lg group transition-all duration-200 ease-in-out 
                            <?php echo e($this->isActiveRoute('reporte-evaluacion') ? 'bg-blue-50 text-blue-600 border-r-4 border-blue-600 shadow-sm' : 'text-gray-600 hover:text-blue-600 hover:bg-blue-50 hover:shadow-md'); ?>">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-3 transition-colors duration-200 
                                <?php echo e($this->isActiveRoute('reporte-evaluacion') ? 'text-blue-500' : 'text-gray-400 group-hover:text-blue-500'); ?>" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <?php echo e($this->isActiveRouteGroup(['reaking-excelencia']) ? 'bg-blue-50 text-blue-600 shadow-sm' : 'text-gray-600 hover:text-blue-600 hover:bg-blue-50 hover:shadow-md'); ?>">
                                                    <div class="flex items-center">
                                                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-3 transition-colors duration-200 
                                <?php echo e($this->isActiveRouteGroup(['reaking-excelencia']) ? 'text-blue-500' : 'text-gray-400 group-hover:text-blue-500'); ?>" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                    ...
                                                    <svg class="w-4 h-4 transition-all duration-300 ease-in-out 
                            <?php echo e($this->isActiveRouteGroup(['reaking-excelencia']) ? 'text-blue-400' : 'text-gray-400'); ?> 
                            <?php echo e($this->isMenuOpen('rakingexcelencias') ? 'rotate-180' : 'rotate-0'); ?>" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                                                    </svg>
                                                </button>
                                                <div class="overflow-hidden transition-all duration-300 ease-in-out 
                        <?php echo e($this->isMenuOpen('rakingexcelencias') ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0'); ?> mt-1 ml-4 space-y-1">
                                                    <a href="<?php echo e(route('reaking-excelencia')); ?>"
                                                        wire:click="closeMenus"
                                                        class="flex items-center px-3 py-2.5 rounded-lg group transition-all duration-200 ease-in-out 
                            <?php echo e($this->isActiveRoute('reaking-excelencia') ? 'bg-blue-50 text-blue-600 border-r-4 border-blue-600 shadow-sm' : 'text-gray-600 hover:text-blue-600 hover:bg-blue-50 hover:shadow-md'); ?>">
                                                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-3 transition-colors duration-200 
                                <?php echo e($this->isActiveRoute('reporte-evaluacion') ? 'text-blue-500' : 'text-gray-400 group-hover:text-blue-500'); ?>" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <?php echo e($this->isActiveRouteGroup(['crear-compromiso']) ? 'bg-blue-50 text-blue-600 shadow-sm' : 'text-gray-600 hover:text-blue-600 hover:bg-blue-50 hover:shadow-md'); ?>">
                                                        <div class="flex items-center">
                                                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-3 transition-colors duration-200 
                <?php echo e($this->isActiveRouteGroup(['crear-compromiso']) ? 'text-blue-500' : 'text-gray-400 group-hover:text-blue-500'); ?>" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                        ...
                                                        <svg class="w-4 h-4 transition-all duration-300 ease-in-out 
            <?php echo e($this->isActiveRouteGroup(['crear-compromiso']) ? 'text-blue-400' : 'text-gray-400'); ?> 
            <?php echo e($this->isMenuOpen('compromisosusers') ? 'rotate-180' : 'rotate-0'); ?>" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                                                        </svg>
                                                    </button>
                                                    <div class="overflow-hidden transition-all duration-300 ease-in-out 
        <?php echo e($this->isMenuOpen('compromisosusers') ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0'); ?> mt-1 ml-4 space-y-1">
                                                        <!-- CORRECCIÓN: Usar la ruta SIN parámetros -->
                                                        <a href="<?php echo e(route('crear-compromiso')); ?>"
                                                            wire:click="closeMenus"
                                                            class="flex items-center px-3 py-2.5 rounded-lg group transition-all duration-200 ease-in-out 
            <?php echo e($this->isActiveRoute('crear-compromiso') ? 'bg-blue-50 text-blue-600 border-r-4 border-blue-600 shadow-sm' : 'text-gray-600 hover:text-blue-600 hover:bg-blue-50 hover:shadow-md'); ?>">
                                                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-3 transition-colors duration-200 
                <?php echo e($this->isActiveRoute('crear-compromiso') ? 'text-blue-500' : 'text-gray-400 group-hover:text-blue-500'); ?>" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 9v6m3-3H9m12 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                                                            </svg>
                        ...
                        <?php echo e($this->isActiveRouteGroup(['asignar-roles', 'gestion-roles']) ? 'bg-blue-50 text-blue-600 shadow-sm' : 'text-gray-600 hover:text-blue-600 hover:bg-blue-50 hover:shadow-md'); ?>">
                                                        <div class="flex items-center">
                                                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-3 transition-colors duration-200 
                                <?php echo e($this->isActiveRouteGroup(['asignar-roles', 'gestion-roles']) ? 'text-blue-500' : 'text-gray-400 group-hover:text-blue-500'); ?>" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                        ...
                                                        <svg class="w-4 h-4 transition-all duration-300 ease-in-out 
                            <?php echo e($this->isActiveRouteGroup(['asignar-roles', 'gestion-roles']) ? 'text-blue-400' : 'text-gray-400'); ?> 
                            <?php echo e($this->isMenuOpen('rolespermisos') ? 'rotate-180' : 'rotate-0'); ?>" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                                                        </svg>
                                                    </button>
                                                    <div class="overflow-hidden transition-all duration-300 ease-in-out 
                        <?php echo e($this->isMenuOpen('rolespermisos') ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0'); ?> mt-1 ml-4 space-y-1">
                                                        <a href="<?php echo e(route('asignar-roles')); ?>"
                                                            wire:click="closeMenus"
                                                            class="flex items-center px-3 py-2.5 rounded-lg group transition-all duration-200 ease-in-out 
                            <?php echo e($this->isActiveRoute('asignar-roles') ? 'bg-blue-50 text-blue-600 border-r-4 border-blue-600 shadow-sm' : 'text-gray-600 hover:text-blue-600 hover:bg-blue-50 hover:shadow-md'); ?>">
                                                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-3 transition-colors duration-200 
                                <?php echo e($this->isActiveRoute('asignar-roles') ? 'text-blue-500' : 'text-gray-400 group-hover:text-blue-500'); ?>" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                        ...
                                                        <a href="<?php echo e(route('gestion-roles')); ?>"
                                                            wire:click="closeMenus"
                                                            class="flex items-center px-3 py-2.5 rounded-lg group transition-all duration-200 ease-in-out 
                            <?php echo e($this->isActiveRoute('gestion-roles') ? 'bg-blue-50 text-blue-600 border-r-4 border-blue-600 shadow-sm' : 'text-gray-600 hover:text-blue-600 hover:bg-blue-50 hover:shadow-md'); ?>">
                                                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-3 transition-colors duration-200 
                                <?php echo e($this->isActiveRoute('gestion-roles') ? 'text-blue-500' : 'text-gray-400 group-hover:text-blue-500'); ?>" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
</div><?php /**PATH D:\laragon\www\encuesta-pro360\resources\views/livewire/menu-navegacion.blade.php ENDPATH**/ ?>