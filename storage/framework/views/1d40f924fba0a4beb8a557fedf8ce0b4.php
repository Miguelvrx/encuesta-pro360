    ...
    <div class="max-w-7xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-lg shadow-md border border-gray-200/80">
            <div class="bg-indigo-700 rounded-t-lg p-4 flex justify-between items-center">
                ...
                <a href="<?php echo e(route('catalogo-competencia')); ?>" wire:navigate class="inline-flex items-center px-3 py-1.5 border border-transparent text-sm font-medium rounded-md text-indigo-700 bg-white hover:bg-indigo-50 transition-colors">
            ...
            <div class="p-6 grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                    ...
                    <select wire:model.live="competenciaSeleccionada" id="competencia" class="block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md disabled:bg-gray-100 disabled:cursor-not-allowed" <?php if($competenciasFiltradas->isEmpty()): ?> disabled <?php endif; ?>>
                        <option value="">
        ...
        <div class="mt-8">
            ...
            <div class="bg-gradient-to-r from-indigo-50 to-blue-50 rounded-lg p-6 mb-6 border border-indigo-200">
                <div class="flex items-start">
                    ...
                    <div class="ml-4 flex-1">
                        ...
                        <h3 class="text-lg font-bold text-gray-900"><?php echo e($competenciaActual->nombre_competencia); ?></h3>
                        <p class="mt-1 text-sm text-gray-600"><?php echo e($competenciaActual->definicion_competencia); ?></p>
                        <div class="mt-2 text-xs text-gray-500">
                            <strong>Niveles definidos:</strong> <?php echo e($competenciaActual->niveles->count()); ?> |
                            <strong>Preguntas creadas:</strong> <?php echo e($competenciaActual->preguntas->count()); ?>
            ...
            <!--[if BLOCK]><![endif]--><?php if($competenciaActual->preguntas->isNotEmpty()): ?>
                            ...
                            <div class="flex-1 min-w-0">
                                <div class="flex items-center gap-3 mb-2">
                                    <span class="flex-shrink-0 inline-flex items-center justify-center w-8 h-8 rounded-full bg-indigo-100 text-indigo-700 font-bold text-sm">
                                        <?php echo e($pregunta->orden); ?>

                                    </span>
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e($pregunta->activa ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'); ?>">
                                        <?php echo e($pregunta->activa ? 'Activa' : 'Inactiva'); ?>

                                    </span>
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                                        Max: <?php echo e($pregunta->puntuacion_maxima); ?> pts
                                    </span>
                                </div>
                                <h4 class="text-base font-semibold text-gray-900"><?php echo e($pregunta->texto_pregunta); ?></h4>
                                <p class="mt-1 text-sm text-gray-600"><?php echo e($pregunta->descripcion_pregunta); ?></p>
                            </div>

                            <div class="ml-4 flex-shrink-0 flex items-center gap-2">
                                <button wire:click="editarPregunta(<?php echo e($pregunta->id_pregunta); ?>)" type="button" class="inline-flex items-center px-3 py-1.5 border border-gray-300 shadow-sm text-xs font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 transition-colors">
                                ...
                                <button wire:click="cambiarEstado(<?php echo e($pregunta->id_pregunta); ?>)" type="button" class="inline-flex items-center px-3 py-1.5 border border-gray-300 shadow-sm text-xs font-medium rounded-md <?php echo e($pregunta->activa ? 'text-red-700 bg-white hover:bg-red-50' : 'text-green-700 bg-white hover:bg-green-50'); ?> transition-colors">
                                    <?php echo e($pregunta->activa ? 'Desactivar' : 'Activar'); ?>

                                </button>
                                <button wire:click="eliminarPregunta(<?php echo e($pregunta->id_pregunta); ?>)" wire:confirm="¿Estás seguro de eliminar esta pregunta?" type="button" class="inline-flex items-center px-3 py-1.5 border border-transparent text-xs font-medium rounded-md text-white bg-red-600 hover:bg-red-700 transition-colors">
                            ...
                            <div class="sm:flex sm:items-start">
                                ...
                                <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                    <h3 class="text-lg leading-6 font-medium text-gray-900" id="modal-title">
                                        <?php echo e($preguntaEditando ? 'Editar Pregunta' : 'Nueva Pregunta'); ?>
                                    ...
                                    <div class="mt-4 space-y-4">
                                        ...
                                        <div>
                                            ...
                                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['texto_pregunta'];
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                        ...
                                        <div>
                                            ...
                                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['descripcion_pregunta'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <p class="mt-1 text-sm text-red-600"><?php echo e($message); ?></p> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                            ...
                                            <div>
                                                ...
                                                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['puntuacion_maxima'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <p class="mt-1 text-sm text-red-600"><?php echo e($message); ?></p> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse gap-2">
                            <button type="submit" class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-indigo-600 text-base font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:ml-3 sm:w-auto sm:text-sm">
                                <?php echo e($preguntaEditando ? 'Actualizar' : 'Guardar'); ?>
...
</div><?php /**PATH D:\laragon\www\encuesta-pro360\resources\views/livewire/encuesta/pregunta/gestionar-pregunta.blade.php ENDPATH**/ ?>