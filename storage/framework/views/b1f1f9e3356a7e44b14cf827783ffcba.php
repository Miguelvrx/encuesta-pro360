                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gradient-to-r from-gray-50 to-gray-100/80">
                            <tr>
                                ...
                                <th scope="col" wire:click="ordenar('username')"
                                    ...
                                    <div class="flex items-center">
                                        <span>Username</span>
                                        <!--[if BLOCK]><![endif]--><?php if($ordenarPor === 'username'): ?>
                                        <span class="ml-1 transform transition-transform duration-200 <?php echo e($direccionOrden === 'asc' ? 'rotate-0' : 'rotate-180'); ?>">
                                            <svg class="w-4 h-4 text-indigo-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 15l7-7 7 7" />
                                            </svg>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr wire:key="<?php echo e($usuario->id); ?>"
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <img class="h-12 w-12 rounded-xl object-cover border-2 border-gray-200 shadow-sm group-hover:shadow-md transition-shadow duration-300" src="<?php echo e($usuario->profile_photo_url); ?>" alt="<?php echo e($usuario->name); ?>">
                                        <div class="ml-4">
                                ...
                                <!-- Celda: Username -->
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <!--[if BLOCK]><![endif]--><?php if($usuario->username): ?>
                                    <div class="flex items-center">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-center">
                                    <span class="px-3 py-1.5 inline-flex text-xs leading-5 font-semibold rounded-full shadow-sm transition-all duration-200
                                        <?php if($usuario->estado == 'activo'): ?> bg-gradient-to-r from-green-100 to-emerald-100 text-green-800 border border-green-200
