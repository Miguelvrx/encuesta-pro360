                    ...
                    <div class="p-6">
                        ...
                        <div class="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" wire:model="name" id="name" placeholder="Ej. Juan Carlos" class="mt-1 w-full input-style <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                            ...
                            <div>
                                ...
                                <input type="text" wire:model="primer_apellido" id="primer_apellido" placeholder="Ej. López" class="mt-1 w-full input-style <?php $__errorArgs = ['primer_apellido'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> input-error <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                            ...
                            <div>
                                ...
                                <input type="tel" wire:model="telefono" id="telefono" placeholder="+52 222 123 4567" class="mt-1 w-full input-style <?php $__errorArgs = ['telefono'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> input-error <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                            ...
                            <div>
                                ...
                                <input type="text" wire:model="puesto" id="puesto" placeholder="Ej. Analista de Datos" class="mt-1 w-full input-style <?php $__errorArgs = ['puesto'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> input-error <?php unset($message);
...
</div><?php /**PATH D:\laragon\www\encuesta-pro360\resources\views/livewire/encuesta/usuario/crear-usuario.blade.php ENDPATH**/ ?>