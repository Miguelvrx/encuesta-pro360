    ...
    <div class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        <header class="mb-8">
            <div class="flex justify-between items-center bg-white p-6 rounded-xl shadow-md">
                ...
                <a href="<?php echo e(route('crear-departamento')); ?>" wire:navigate class="inline-flex items-center px-4 py-2 bg-blue-600 text-white font-semibold text-sm rounded-lg shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors">
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            <th scope="col" wire:click="ordenar('nombre_departamento')" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer">
                                Departamento <!--[if BLOCK]><![endif]--><?php if($ordenarPor === 'nombre_departamento'): ?><span><?php echo e($direccionOrden === 'asc' ? '▲' : '▼'); ?></span><?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                            </th>
                            ...
                            <th scope="col" wire:click="ordenar('puesto')" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer">
                                Puesto Principal <!--[if BLOCK]><![endif]--><?php if($ordenarPor === 'puesto'): ?><span><?php echo e($direccionOrden === 'asc' ? '▲' : '▼'); ?></span><?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                            </th>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr wire:key="<?php echo e($departamento->id_departamento); ?>" class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full <?php echo e($departamento->estado == 'activo' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'); ?>">
                                    <?php echo e(ucfirst($departamento->estado)); ?>

                                </span>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <a href="<?php echo e(route('ver-departamento', $departamento)); ?>" wire:navigate class="text-blue-600 hover:text-blue-900">Ver</a>
                                <a href="<?php echo e(route('editar-departamento', $departamento)); ?>" wire:navigate class="ml-4 text-indigo-600 hover:text-indigo-900">Editar</a>
                                <button x-data @click="$dispatch('confirm-delete', { id: <?php echo e($departamento->id_departamento); ?> })" class="ml-4 text-red-600 hover:text-red-900 font-medium">
                                    Eliminar
                                </button>
                            </td>
                        </tr>
