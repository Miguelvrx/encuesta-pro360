                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex items-center gap-4">
                                <span class="inline-flex items-center px-3 py-1.5 rounded-full bg-gradient-to-r from-indigo-100 to-purple-100 text-indigo-700 font-medium text-sm shadow-sm border border-indigo-200/50">
                                    ...
                                    <?php echo e($competenciasTotales ?? 0); ?> Competencias Disponibles
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-3">
                                <p class="text-sm text-indigo-700 font-medium">
                                    Mostrando <span class="font-bold"><?php echo e($competenciasCatalogo->count()); ?></span> competencia(s) de esta categoría
                                </p>
                            </div>
                        </div>
                    </div>
