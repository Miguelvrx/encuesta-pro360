                            ...
                            <div class="grid grid-cols-12 gap-x-6 items-start">
                                ...
                                <div class="col-span-12 md:col-span-5">
                                    ...
                                    <div class="flex items-baseline gap-3">
                                        <span class="text-3xl font-bold text-blue-600 w-5 text-center"><?php echo e($datosNivel['numero']); ?></span>
                                        <div>
                                            <p class="text-base font-semibold text-gray-800"><?php echo e($nivel->nombre_nivel); ?></p>
                                            <p class="text-xs text-gray-500 italic">"<?php echo e($datosNivel['tagline']); ?>"</p>
                                        </div>
                                    </div>
                                    <?php else: ?>
