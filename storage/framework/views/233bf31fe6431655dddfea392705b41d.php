                ...
                <div>
                    ...
                    <div class="flex gap-3">
                        <select wire:model="encuestadoSeleccionado" class="flex-1 px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent">
                            ...
                            <option value="<?php echo e($usuario->id); ?>"><?php echo e($usuario->name); ?> <?php echo e($usuario->primer_apellido); ?> - <?php echo e($usuario->puesto); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                        </select>
                    ...
                    <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['encuestados'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        ...
                        <div class="relative bg-gradient-to-br from-green-400 to-green-500 rounded-lg p-4 text-white shadow-lg">
                            <button wire:click="eliminarEncuestado(<?php echo e($index); ?>)" type="button" class="absolute top-2 right-2 bg-white text-red-500 rounded-full p-1 hover:bg-red-50">
                ...
                <div class="space-y-8">
                    ...
                    <div class="border-2 border-gray-200 rounded-xl p-6 bg-gray-50">
                        <div class="flex items-center gap-3 mb-4">
                            ...
                            <div>
                                <h3 class="text-lg font-bold text-gray-900"><?php echo e($encuestado['nombre']); ?></h3>
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="flex items-center justify-between bg-white p-3 rounded-lg border border-gray-200">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p class="text-sm font-semibold text-gray-900"><?php echo e($calificador['nombre']); ?></p>
                                        <p class="text-xs text-gray-500"><?php echo e($calificador['email']); ?></p>
                                    </div>
                                </div>
                                <div class="flex items-center gap-2">
                                    <span class="px-3 py-1 text-xs font-semibold rounded-full 
                                <?php echo e($calificador['tipo_rol'] == 'Autoevaluación' ? 'bg-purple-100 text-purple-700' : ''); ?>
                                ...
                                <?php echo e($calificador['tipo_rol'] == 'Cliente' ? 'bg-yellow-100 text-yellow-700' : ''); ?>">
                                    ...
                                    <button wire:click="eliminarCalificador(<?php echo e($indexEnc); ?>, <?php echo e($indexCal); ?>)" type="button" class="text-red-600 hover:text-red-800 transition-colors">
