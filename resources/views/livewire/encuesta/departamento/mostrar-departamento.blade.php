                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr wire:key="{{ $departamento->id_departamento }}"
                                ...
                                <td class="px-6 py-4 text-sm text-gray-500">
                                    <div class="max-w-xs" title="{{ $departamento->descripcion }}">
                                        {{ \Illuminate\Support\Str::limit($departamento->descripcion, 60) }}
                                    </div>
                                </td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-center">
                                    <span class="px-3 py-1.5 inline-flex text-xs leading-5 font-semibold rounded-full shadow-sm transition-all duration-200
                                        @if($departamento->estado == 'activo') bg-gradient-to-r from-green-100 to-emerald-100 text-green-800 border border-green-200
