    ...
    <div class="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-white py-8 px-4 sm:px-6 lg:px-8">
        <form wire:submit.prevent="save" class="space-y-8 max-w-5xl mx-auto">
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="number" wire:model="ano_mercado" id="ano_mercado" placeholder="Ej. 1987" min="1900" max="{{ date('Y') }}" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500">
            ...
            <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                ...
                <div class="p-6">
                    ...
                    <div class="mt-4" wire:loading.remove wire:target="logo">
                        ...
                        <img src="{{ $logo->temporaryUrl() }}" class="w-32 h-32 object-cover rounded-lg mx-auto shadow-md" alt="Previsualización del logo">
                    </div>
                    @endif
                    @error('logo') <span class="text-red-500 text-sm mt-1 block text-center">{{ $message }}</span> @enderror
                </div>
            </div>
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select wire:model.live="estado" id="estado" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500" {{ empty($states) ? 'disabled' : '' }}>
                        ...
                        <div>
                            ...
                            <select wire:model="ciudad" id="ciudad" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500" {{ empty($cities) ? 'disabled' : '' }}>
                                <option value="">Selecciona una ciudad</option>
                                @foreach ($cities as $city)
                                    <option value="{{ $city }}">{{ $city }}</option>
                                @endforeach
                            </select>
                            @error("ciudad") <span class="text-red-500 text-sm mt-1">{{ $message }}</span> @enderror
                        </div>
                        <div>
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div>
                            ...
                            @error("contacto_nombre") <span class="text-red-500 text-sm mt-1">{{ $message }}</span> @enderror
                        </div>
                        <div>
                            ...
                            @error("contacto_puesto") <span class="text-red-500 text-sm mt-1">{{ $message }}</span> @enderror
                        </div>
                        <div>
                            ...
                            @error("contacto_telefono") <span class="text-red-500 text-sm mt-1">{{ $message }}</span> @enderror
                        </div>
                        <div>
                            ...
                            @error("contacto_correo") <span class="text-red-500 text-sm mt-1">{{ $message }}</span> @enderror
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="flex justify-center space-x-4 pt-6">
                <a href="{{ route('mostrar-empresa') }}" wire:navigate class="px-8 py-3 bg-gray-200 text-gray-700 font-medium rounded-lg hover:bg-gray-300 transition-colors">
                    Cancelar
                </a>
