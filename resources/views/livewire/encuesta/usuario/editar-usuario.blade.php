    ...
    <div class="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-white py-8 px-4 sm:px-6 lg:px-8">
        ...
        <form wire:submit.prevent="update" class="space-y-8 max-w-5xl mx-auto">
                    ...
                    <div class="mt-6 space-y-6">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-xs text-gray-500">
                                @if($username)
                                Puede iniciar sesión con: <span class="font-semibold">{{ $username }}</span> o su correo electrónico
                                @else
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input
                                    ...
                                    class="mt-1 w-full input-style @error('password') input-error @enderror">
            ...
            <div class="flex justify-center space-x-4 pt-6">
                <a href="{{ route('mostrar-usuario') }}" wire:navigate class="px-8 py-3 bg-gray-200 text-gray-700 font-medium rounded-lg hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-400 transition-colors">
                    Cancelar
                </a>
