                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr wire:key="{{ $usuario->id }}" class="hover:bg-gray-50 transition-colors duration-150">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <img class="h-12 w-12 rounded-lg object-cover border-2 border-gray-200 shadow-sm" src="{{ $usuario->profile_photo_url }}" alt="{{ $usuario->name }}">
                                        <div class="ml-4">
