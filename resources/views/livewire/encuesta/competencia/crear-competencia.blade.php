{{-- resources/views/livewire/encuesta/competencia/crear-competencia.blade.php --}}
<div>
        ...
        <form wire:submit.prevent="save" class="space-y-8">
            ...
            <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                <div class="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-4">
                    ...
                    <p class="text-sm text-blue-200 mt-1">Define una competencia y sus niveles de comportamiento.</p>
                </div>
            ...
            <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                <div class="bg-gradient-to-r from-gray-700 to-gray-800 px-6 py-4">
                    ...
                    <p class="text-sm text-gray-300 mt-1">Define los distintos grados de dominio de la competencia.</p>
                </div>
                    ...
                    <div wire:key="nivel-{{ $index }}" class="p-4 border border-gray-200 rounded-lg relative">
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            <div>
                                ...
                                <input type="text" wire:model="niveles.{{ $index }}.nombre_nivel" id="nivel_nombre_{{ $index }}" placeholder="Ej. Sobresaliente, Competente, En Desarrollo" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">
                            ...
                            <div>
                                ...
                                <textarea wire:model="niveles.{{ $index }}.descripcion_nivel" id="nivel_descripcion_{{ $index }}" rows="3" placeholder="Describe qué hace una persona en este nivel..." class="mt-1 block w-full rounded-md border-gray-300 shadow-sm"></textarea>
