            ...
            <header class="mb-8">
                <div class="flex justify-between items-center bg-white p-6 rounded-xl shadow-md">
                    ...
                    <div class="flex items-center space-x-3">
                        ...
                        <!-- Botón Volver -->
                        <a href="{{ route('mostrar-empresa') }}" wire:navigate class="inline-flex items-center px-4 py-2 bg-gray-600 text-white font-semibold text-sm rounded-lg shadow-sm hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 transition-colors">
                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-50 transition-colors duration-150">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        ...
                                        <div class="h-10 w-10 rounded-lg bg-white border border-gray-200 flex items-center justify-center p-1 flex-shrink-0">
                                            <img src="{{ asset('storage/' . $empresa->logo) }}" alt="Logo" class="max-h-full max-w-full object-contain">
                                        </div>
                                        @else
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                    {{ $empresa->deleted_at->format('d/m/Y H:i') }}
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex justify-end space-x-2">
                                        <!-- Botón Restaurar -->
                                        <button
                                            wire:click="restaurarEmpresa({{ $empresa->id_empresa }})"
                                        ...
                                        <button
                                            x-data
                                            @click="$dispatch('confirm-delete-permanent', { id: {{ $empresa->id_empresa }} })"
