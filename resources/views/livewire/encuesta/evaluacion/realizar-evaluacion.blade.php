            ...
            <div class="p-6 space-y-8">
                ...
                <div class="border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
                    <div class="flex items-start gap-4 mb-4">
                        ...
                        <div class="flex-1">
                            <h3 class="text-lg font-semibold text-gray-900 mb-2">{{ $pregunta->texto_pregunta }}</h3>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-5 gap-3">
                            ...
                            <label class="relative cursor-pointer group"
                                ...
                                <div class="p-4 border-2 border-gray-200 rounded-lg text-center transition-all duration-200 peer-checked:border-blue-500 peer-checked:bg-blue-50 peer-checked:shadow-md hover:border-gray-300">
                                    <div class="text-2xl font-bold text-gray-700 mb-1">{{ $valor }}</div>
                                    <div class="text-xs font-semibold text-gray-600">{{ $nivel['nombre'] }}</div>
